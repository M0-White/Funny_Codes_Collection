...
int main()
{
	...
	int row=8,col=8;
	int i,j;
	PlaySound("马克西姆-克罗地亚狂想曲.wav",NULL,SND_FILENAME|SND_ASYNC|SND_LOOP);/*PlaySound函数用于播放音频，详情点击这里<a target=_blank href="http://baike.sogou.com/v10930259.htm?fromTitle=playsound">http://baike.sogou.com/v10930259.htm?fromTitle=playsound</a> */
	MessageBox(NULL,"制作人：天妒\n背景音乐：马克西姆-克罗地亚狂想曲","扫雷 V1.0",MB_OK);
